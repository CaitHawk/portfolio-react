        ...
        <section className="aboutMain" id="aboutSection">
            <div className="aboutWrapper">
                <div className="aboutInfoDiv">
                    ...
                    <p className="aboutInfoParagraph">Engineer, mother, nature lover, activist, cat owner, island girl. Oahu native with a perfect work-life balance. I'm a puzzle master and logic guru who literally codes for fun. Nothing gets me more than a good book, a good laugh, and good food.</p>
