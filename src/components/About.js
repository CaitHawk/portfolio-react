            ...
            <div className="aboutWrapper">
                ...
                <div className="aboutImgSocialDiv">
                    ...
                    <div className="aboutSocialLinksDiv">
                        <a href="https://github.com/CaitHawk" target="_blank"><FontAwesomeIcon icon={faGithub} /></a>
                        <a href="https://twitter.com/CaitlinNeathawk" target="_blank"><FontAwesomeIcon icon={faTwitter} /></a>
                        <a href="https://www.linkedin.com/in/caitlin-neathawk-56216a228/" target="_blank"><FontAwesomeIcon icon={faLinkedin} /></a>
                    </div>
                </div>
            </div>
        </section>
